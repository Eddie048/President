...
public class Deck {
    ...
    /**
     * Shuffle the deck by doing a series of random swaps
     */
    public void shuffle() {
    ...
    /**
     * For testing purposes, tests the deck for having all cards
     * @return true if deck has all cards, false otherwise
     */
